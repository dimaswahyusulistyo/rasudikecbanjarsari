<template>
    <div>
        ...
        <div class="container-fluid d-flex justify-content-center">
            <div class="card border mb-4 w-75">
                <CCardHeader class="d-flex justify-content-between align-items-center">
                    <div>
                        <ul class="nav nav-underline-border" role="navigation">
                            <li class="nav-item">
                                <a class="nav-link" target="_blank" @click="$router.push('/detailarsip')">
                                    <svg class="icon me-2 me-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"
                                        role="img">
                                        <CIcon icon="cilInfo" />
                                    </svg>
                                    Detail Surat
